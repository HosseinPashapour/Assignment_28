...
writer = cv2.VideoWriter('Output/Record.mp4', cv2.VideoWriter_fourcc(*'MJPG'), 8, (cols, rows))
image_sticker=cv2.imread("Input/Bob_sticker.png")
image_glasses=cv2.imread("Input/Glasses.png")
image_lips=cv2.imread("Input/Lips.png")
